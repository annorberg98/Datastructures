...
using Datastructures.HeplerMethods;
...
namespace Datastructures.Graph
{
    public class UndirectedDenseGraph<T> : IGraph<T> where T : IComparable<T>
    {
        ...
        /// </summary>
        public virtual Datastructures.LinkedList.DLinkedList<T> Neighbours(T vertex)
        {
        ...
        public virtual IEnumerable<T> DepthFirstWalk(T source)
        {
            ...
            var stack = new Datastructures.Stack.Stack<T>(_verticesCount);
        ...
        public virtual IEnumerable<T> BreadthFirstWalk(T source)
        {
            ...
            var visited = new HashSet<T>();
            var queue = new Datastructures.Queue.Queue<T>(VerticesCount);
